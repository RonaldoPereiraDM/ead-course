...
(course_id, course_level, course_status, creation_date, description, image_url, last_update_date, name, user_instructor)
VALUES
('605b5e70-3511-4727-896e-6a54711adb1d', 'INTERMEDIARY', 'CONCLUDED',
...
(course_id, course_level, course_status, creation_date, description, image_url, last_update_date, name, user_instructor)
VALUES
('9ea7ad8e-8086-42f4-b042-7f5ce587c4a0', 'ADVANCED', 'IN_PROGRESS',
...
(course_id, course_level, course_status, creation_date, description, image_url, last_update_date, name, user_instructor)
VALUES
('7f07fa21-9f88-45f3-8603-0d811703825d', 'BEGINNER', 'CONCLUDED',
...
(course_id, course_level, course_status, creation_date, description, image_url, last_update_date, name, user_instructor)
VALUES
('d021eb9a-5354-4dbd-ac92-983b5ae85ec6', 'INTERMEDIARY', 'IN_PROGRESS',
...
'Introdução ao Quality Assurance e Tipos de Testes', '605b5e70-3511-4727-896e-6a54711adb1d');

INSERT INTO tb_modules (module_id, creation_date, description, title, course_course_id)
VALUES ('aaaa2222-f639-438f-8f69-c6e515fd541d', '2024-09-11 09:00:00.0000',
'Módulo 2 - Selenium WebDriver',
'Automação de Testes com Selenium WebDriver', '605b5e70-3511-4727-896e-6a54711adb1d');

INSERT INTO tb_modules (module_id, creation_date, description, title, course_course_id)
VALUES ('aaaa3333-f749-438f-8f69-c6e515fd542e', '2024-09-12 09:00:00.0000',
'Módulo 3 - Cypress',
'Testes End-to-End com Cypress', '605b5e70-3511-4727-896e-6a54711adb1d');

INSERT INTO tb_modules (module_id, creation_date, description, title, course_course_id)
VALUES ('aaaa4444-f859-438f-8f69-c6e515fd543f', '2024-09-13 09:00:00.0000',
'Módulo 4 - JUnit e Testes Unitários',
'Testes Unitários com JUnit e Práticas Avançadas', '605b5e70-3511-4727-896e-6a54711adb1d');
...
'Fundamentos de DevOps', '9ea7ad8e-8086-42f4-b042-7f5ce587c4a0');
...
'Infraestrutura como Código', '9ea7ad8e-8086-42f4-b042-7f5ce587c4a0');
...
'Containers e Orquestração', '9ea7ad8e-8086-42f4-b042-7f5ce587c4a0');
...
'CI/CD e Automação', '9ea7ad8e-8086-42f4-b042-7f5ce587c4a0');
...
'Fundamentos do Product Owner', '7f07fa21-9f88-45f3-8603-0d811703825d');
...
'Gestão do Product Backlog', '7f07fa21-9f88-45f3-8603-0d811703825d');
...
'Scrum para Product Owners', '7f07fa21-9f88-45f3-8603-0d811703825d');
...
'Métricas e Valor de Negócio', '7f07fa21-9f88-45f3-8603-0d811703825d');
...
'Fundamentos do GitHub', 'd021eb9a-5354-4dbd-ac92-983b5ae85ec6');
...
'Branches e Pull Requests', 'd021eb9a-5354-4dbd-ac92-983b5ae85ec6');
...
'Colaboração e Ferramentas Sociais', 'd021eb9a-5354-4dbd-ac92-983b5ae85ec6');
...
'GitHub Actions e Automação', 'd021eb9a-5354-4dbd-ac92-983b5ae85ec6');
...
------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------ Pedro Henrique  'e1b6f1b8-c25d-40a1-9460-8c510cc478fa' está inscritos nos cursos: -------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------

-------------------------------------------------    Full Stack Development   ------------------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), 'e1b6f1b8-c25d-40a1-9460-8c510cc478fa', 'abcdef12-3456-7890-abcd-ef1234567890');

------------------------------------------------   Quality Assurance Master Course   -----------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), 'e1b6f1b8-c25d-40a1-9460-8c510cc478fa', '605b5e70-3511-4727-896e-6a54711adb1d');

------------------------------------------------   DevOps Engineering Professional   -----------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), 'e1b6f1b8-c25d-40a1-9460-8c510cc478fa', '9ea7ad8e-8086-42f4-b042-7f5ce587c4a0');

------------------------------------------------   Node.js Advanced Development   --------------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), 'e1b6f1b8-c25d-40a1-9460-8c510cc478fa', '98765432-9876-4321-abcd-123456789abc');


------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------- Gabriel Oliveira  '2d93a8c1-1a34-4a06-bf1e-7f95f2252883' está inscritos nos cursos: -------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------

-------------------------------------------------    Full Stack Development   ------------------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), '2d93a8c1-1a34-4a06-bf1e-7f95f2252883', 'abcdef12-3456-7890-abcd-ef1234567890');

------------------------------------------------   Quality Assurance Master Course   -----------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), '2d93a8c1-1a34-4a06-bf1e-7f95f2252883', '605b5e70-3511-4727-896e-6a54711adb1d');

------------------------------------------------   DevOps Engineering Professional   -----------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), '2d93a8c1-1a34-4a06-bf1e-7f95f2252883', '9ea7ad8e-8086-42f4-b042-7f5ce587c4a0');


------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------  Marcos Rodrigues  '8ba18953-9093-45b0-9509-d4cbe5806409' está inscritos nos cursos:  ------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------

-------------------------------------------------    Full Stack Development   ------------------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), '8ba18953-9093-45b0-9509-d4cbe5806409', 'abcdef12-3456-7890-abcd-ef1234567890');

-------------------------------------------------   Product Owner Fundamentals   ---------------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), '8ba18953-9093-45b0-9509-d4cbe5806409', '7f07fa21-9f88-45f3-8603-0d811703825d');

--------------------------------------------------   GitHub Essential Training   ---------------------------------------------------------------
insert into tb_courses_users (id, user_id, course_course_id)
values (gen_random_uuid(), '8ba18953-9093-45b0-9509-d4cbe5806409', 'd021eb9a-5354-4dbd-ac92-983b5ae85ec6');